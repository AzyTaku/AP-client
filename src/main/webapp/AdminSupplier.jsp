                        ...
                        <%}%>
                            ...
                            <script>
                                ...
                                <form>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
                                                    <input type="submit" class="btn btn-primary btn-block" value="Update Supplier" name="upd" input><br>
                                                    <input type="submit" class="btn btn-primary btn-block" value="Delete Supplier" name="dlt" input><br>
                                                    <input type="submit" class="btn btn-primary btn-block" value="Add Supplier" name="add" input>
                                                </div>
                                            </div>
                                        </form>
                                <%
