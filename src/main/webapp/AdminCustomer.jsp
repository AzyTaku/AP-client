                                ...
                                <form>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
                                                    ...
                                                    <input type="submit" class="btn btn-primary btn-block" value="Delete User" name="dlt" input><br>
                                                    <input type="submit" class="btn btn-primary btn-block" value="Add User" name="add" input>
                                                </div>
                                            </div>
                                        </form>
                                <%
