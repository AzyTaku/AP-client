            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">TechMart Admin</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Sales Agent</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                        <%for(User em : Util.getUsers()) {%>
                            <tr>
                                <td><%//out.print(em.get());%></td>
                                <td><%out.print(em.getUsername());%></td>
                                <td><%out.print(em.getPassword());%></td>
                                <td><%out.print(em.getFirstName());%></td>
                                <td><%out.print(em.getLastName());%></td>
                            </tr>
                        <%}%>
                                </tbody>
                            <script>
